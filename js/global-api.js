...
export function exposeGlobals(playerController, playlistManager, ui, storage, cameraManager, motionManager, exerciseTimer) {
    ...
    if (scoreElement) {
        ...
        try {
            const t = ui && ui.i18nManager ? ui.i18nManager.translations[ui.currentLang] : null;
            scoreElement.title = t && t.share_score_title ? t.share_score_title : "Click to share score";
        } catch (_) {
        ...
        scoreElement.onclick = () => {
            try {
                const t = ui && ui.i18nManager ? ui.i18nManager.translations[ui.currentLang] : null;
                ui.showSplash(t && t.share_generating ? t.share_generating : "Generating score image... 📸");
            } catch (_) {
            ...
            setTimeout(() => {
                ...
                if (window.shareScore) {
                    ...
                    try {
                        const t = ui && ui.i18nManager ? ui.i18nManager.translations[ui.currentLang] : null;
                        ui.showSplash(t && t.share_error ? t.share_error : "Error: Share feature not ready");
                    } catch (_) {
