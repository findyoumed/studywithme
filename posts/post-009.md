...
<div class="prose prose-invert max-w-none">
  <h3 class="text-xl font-bold text-primary mb-4">들어가며: 읽기는 이해를 설계하는 과정이다</h3>
  <p class="text-slate-300 mb-6">질문을 가지고 읽으면 기억이 오래 간다.</p>

  <h3 class="text-xl font-bold text-primary mb-4 mt-8">핵심 1: 질문을 세우고 읽기</h3>
  <p class="text-slate-300 mb-6">제목을 훑고 2~3개의 질문을 만든 뒤 답을 찾으며 읽어라.</p>
  ...
  <p class="text-slate-300">각 섹션을 두 문장으로 요약해 보자.</p>
</div>
