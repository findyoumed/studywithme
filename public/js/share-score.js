...
export class ShareScore {
  ...
  async generateScoreImage(score, time, medal = "🥉", medalName = "Novice Focus") {
    ...
    if (medalName && medalName.trim() !== "") {
      ...
      // Use translated medal name if available, otherwise fallback to the key itself
      const translatedMedalName = t[medalName] || medalName;
      ctx.fillText(`"${translatedMedalName}"`, 600, 340);
    ...
    */
    ...
    ctx.fillText(timestamp, 600, 450);
